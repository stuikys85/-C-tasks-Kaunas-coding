...
namespace ConsoleApp152
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int apkeistas24 = digit1;
            int apkeistas42 = digit3;



            Console.WriteLine(digit1sum+""+digit2sum+""+digit3sum+""+digit4sum);
            Console.WriteLine("Mokinys sugalvojo gauta skaitmenio dar kakeisti 2 skaiciu su 4");
            Console.WriteLine(digit1sum + "" + apkeistas24 + "" + digit3sum + "" + apkeistas42);
            Console.ReadKey();
